...
ns.core.Config.SetDefault("ns3::Queue::MaxPackets", ns.core.UintegerValue(500))
...
DNSp2p.SetQueue("ns3::DropTailQueue", "MaxPackets", ns.core.StringValue("5"))
...
def SetupTcpConnection(srcNode, dstNode, dstAddr, startTime, stopTime, ON_OFF_RATE, PACKET_SIZE):
  ...
  on_off_tcp_helper.SetAttribute("PacketSize", ns.core.UintegerValue(PACKET_SIZE)) 
