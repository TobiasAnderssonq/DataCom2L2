...
def SetupTcpConnection(srcNode, dstNode, dstAddr, startTime, stopTime, ON_OFF_RATE):
  ...
  on_off_tcp_helper.SetAttribute("PacketSize", ns.core.UintegerValue(1100)) 
