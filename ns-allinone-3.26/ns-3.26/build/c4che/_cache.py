...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-lMBuS3/python2.7-2.7.12=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-lMBuS3/python2.7-2.7.12=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-lMBuS3/python2.7-2.7.12=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-lMBuS3/python2.7-2.7.12=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['energy', 'naming', 'tcp', 'tutorial', 'matrix-topology', 'realtime', 'stats', 'udp-client-server', 'ipv6', 'wireless', 'socket', 'udp', 'routing', 'error-model', 'traffic-control']
...
NS3_EXECUTABLE_PATH = ['/home/user/ns-allinone-3.26/ns-3.26/build/src/fd-net-device', '/home/user/ns-allinone-3.26/ns-3.26/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/home/user/ns-allinone-3.26/ns-3.26/build']
...
VERSION = '3.26'
WITH_PYBINDGEN = '/home/user/ns-allinone-3.26/pybindgen-0.17.0.post57+nga6376f2'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/user/ns-allinone-3.26/ns-3.26/build/ns3/config-store-config.h', '/home/user/ns-allinone-3.26/ns-3.26/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
